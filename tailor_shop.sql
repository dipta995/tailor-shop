...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3216487815ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tailor_shop&table=cloth_type">`tailor_shop`.`cloth_type`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_blog&table=tbl_category">`db_blog`.`tbl_category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tailor_shop&table=tbl_cloth">`tailor_shop`.`tbl_cloth`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_blog&table=tbl_post">`db_blog`.`tbl_post`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gym&table=package_table">`gym`.`package_table`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gym&table=admin_table">`gym`.`admin_table`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tailor_shop&table=tbl_admin">`tailor_shop`.`tbl_admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gym&table=user_table">`gym`.`user_table`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_lr&table=tbl_user">`db_lr`.`tbl_user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_blog&table=tbl_user">`db_blog`.`tbl_user`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="60417a496a37694b495d2c7e553e3f78">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="gym" targettable="package_table">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `package_table`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tailor_shop" targettable="tbl_cloth">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_cloth`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tailor_shop" targettable="tbl_cloth">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_cloth`  
ORDER BY `tbl_cloth`.`name` ASC</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `tbl_cloth` DROP `del_cloth`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tailor_shop" targettable="tbl_cloth">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_cloth`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="tailor_shop" targettable="cloth_type">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `tailor_shop`.`cloth_type` ( `id` INT NOT NULL AUTO_INCREMENT ,  `name` VARCHAR(255) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tailor_shop" targettable="tbl_cloth">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `cloth_type`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tailor_shop" targettable="cloth_type">
                            <div class="action_content">
